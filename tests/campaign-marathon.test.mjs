...
test('campaign marathon pins every canonical public handoff in one continuous chain', () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      [SCENE_IDS.CARTEL_PALACE, SCENE_IDS.LUXURY_APARTMENT, '/luxury-apartment.html', 'main'],
      [SCENE_IDS.LUXURY_APARTMENT, SCENE_IDS.SPECIAL_MEETING, '/specialmeeting.html', 'kerb'],
