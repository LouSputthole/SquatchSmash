...
- `npm test`: 313/313 repository tests, including recovery, save/resume,
  club/lie/overswing, curved flight, and player-driven cart models.
- `npm run check`: 279 source files and all five manifests valid.
- `npm run verify:golf`: 83/83 live browser checks from the real start button
...
- Audit the 305 entries under **Complete authored ledger — A Morning at Silver
  Pines** in `VOICE-LINES-TODO.md`. Lou has 103, Rippin has 102, Erican has 66,
  and the Prospect has 34. All 305 currently have indexed takes, but every
  filename, exact line, profile and recording status remains visible there.
