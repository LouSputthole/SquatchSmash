...
| --- | --- | --- | --- | --- | --- |
| P1 | Global | Station architecture | The station source comment still documents three selectable stations, but STATIONS exports one live station. | Mechanical: update the comment after the owner decides whether the two legacy identities are retired or returning. | OPEN |
