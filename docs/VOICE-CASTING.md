...
2. **Five Family faces missing.** Old Stove's and Irish's supplied faces now
   live at `assets/faces/stove.png` and `assets/faces/irish.png`. Drop PNGs
   under these remaining ledger names and every scene picks them up:
   `lag.png`, `willy.png`, `ape.png`, `seff.png`, `numbskull.png`.
