# Audio audition queue

This is a selection list, not an instruction to overwrite production sound.
Each listed cue stays live until an owner selects a candidate after listening.

## Current queue — 2026-07-31

| Cue | Scene/use | What is wrong now | Candidate brief | Acceptance check |
|---|---|---|---|---|
...
1. Generate or place three numbered candidates outside the live cue path.
2. Listen in the real scene at the authored mix, not in isolation.
3. Record the selected filename and date here.
4. Replace only the approved production cue, rebuild `assets/sfx/index.json`, and rerun the relevant browser verifier.

No candidate has been selected yet. The Squatchfather horn after the bathroom has been removed separately; it is not awaiting replacement.
