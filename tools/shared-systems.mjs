...
export const SCENE_SYSTEM_ADOPTION = Object.freeze({
  ...
  'luxury-apartment': { objectives: 1, dialogue: 0, interaction: 1, player: 1, hud: 1, pause: 1, inventory: 0, blood: 0, staging: 0, swing: 0, notes: "`staging` went 1 -> 0 on 2026-08-26, and it is a scene losing its cast rather than a scene losing a shared system: the flat's only actors were the three civilian poker patrons, and the owner had them removed -- 'who are these guys at my poker table? Get rid of them.' core/staging.js is the marker for bodies in a scene, and there are no bodies in this one now; the import comes straight back with the first person who is ever staged here. The luxury flat, landed 2026-08-24 and wired to core/objective-panel.js on 2026-08-26. `objectives` was 0 on the argument that a hub with no campaign edge has nothing to put on a card -- but the flat DID have a standing order all along, and it was reachable only from inside the pause menu, which is the exact failure the panel's own header describes. It now drives the #objectives div in luxury-apartment.html, in the starter flat's idiom under the clock, from the one string the pause menu also reads." },
