...
export const SCENE_SYSTEM_ADOPTION = Object.freeze({
  ...
  bing: { objectives: 1, dialogue: 1, interaction: 2, player: 2, hud: 2, pause: 2, inventory: 1, blood: 2, staging: 2, swing: 0 },
  cabin: { objectives: 1, dialogue: 0, interaction: 1, player: 1, hud: 1, pause: 1, inventory: 0, blood: 0, staging: 0, swing: 0, notes: "The countryside hideout hub, landed 2026-08-24. `dialogue` is 0 because nobody in it speaks yet -- it is a place to be between jobs, and its phone content goes through core/phone-content.js rather than a scene dialogue tree. `inventory` and `staging` are the debts to watch when the hub grows people and a loadout." },
