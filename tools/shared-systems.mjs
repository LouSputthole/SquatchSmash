...
export const SCENE_SYSTEM_ADOPTION = Object.freeze({
  ...
  initiation: { objectives: 0, dialogue: 2, interaction: 0, player: 0, hud: 0, pause: 1, inventory: 1, blood: 0, staging: 1, notes: "Frozen pending the owner playtest; see GEOMETRY_FROZEN_WAIVERS." },
