...
export const SCENE_SYSTEM_ADOPTION = Object.freeze({
  ...
  'luxury-apartment': { objectives: 0, dialogue: 0, interaction: 1, player: 1, hud: 1, pause: 1, inventory: 0, blood: 0, staging: 1, swing: 0, notes: "The unplaced luxury flat, landed 2026-08-24: a hub with no campaign edge into it yet, so there is no objective to put on a card. Movement, prompts, HUD, pause and staging are all shared; `objectives` becomes a debt the moment the story gives it a reason to be entered." },
