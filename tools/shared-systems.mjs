...
export const SCENE_SYSTEM_ADOPTION = Object.freeze({
  ...
  beefrun: { objectives: 1, dialogue: 0, interaction: 1, player: 1, hud: 1, pause: 1, inventory: 1, blood: 0, staging: 1, swing: 0, notes: "`objectives` went 0 -> 1 on 2026-09-02: FlightHud.setObjective now hands its one string to the shared card (owner: every scene on the one objective system). The old argument -- a standing-order list over a crosshair is a sticker on the windscreen -- lost to the owner reading four different objective widgets in one playthrough. `dialogue` is the real debt here and it is the same one enolasquatch carries." },
  bing: { objectives: 2, dialogue: 1, interaction: 2, player: 2, hud: 2, pause: 2, inventory: 1, blood: 2, staging: 3, swing: 0 },
  cabin: { objectives: 1, dialogue: 2, interaction: 1, player: 1, hud: 1, pause: 1, inventory: 0, blood: 1, staging: 0, swing: 0, notes: "The countryside hideout now has Lag and the dungeon director on the canonical dialogue pipeline, plus shared blood impact and death-pool presentation for the disposable captives. Phone content still comes through core/phone-content.js. `inventory` and shared cast `staging` remain the debts to watch as this chapter grows." },
  ...
  heist: { objectives: 1, dialogue: 2, interaction: 1, player: 1, hud: 1, pause: 1, inventory: 1, blood: 1, staging: 1, swing: 0, notes: "`dialogue` went to 2 on 2026-08-26: `src/heist/dialogue.js` -- the mission's own arbiter -- now reads the shared SPEECH_MIX constants as well, because the escape drive needed the CLOSE mix rather than a fourth per-scene rolloff of its own. The arbiter itself is still the scene's, and it is a queue rather than a playback path, so it is a companion to core/dialogue.js and not a fork of it." },
  ...
  'luxury-apartment': { objectives: 1, dialogue: 1, interaction: 1, player: 1, hud: 1, pause: 1, inventory: 0, blood: 0, staging: 0, swing: 0, notes: "`staging` went 1 -> 0 on 2026-08-26 because the three civilian poker patrons were intentionally removed; the flat now has no NPC cast, and its reflection-only FirstPersonBody is the player rather than a scene actor. The import returns with the first NPC staged here. The luxury flat, landed 2026-08-24 and wired to core/objective-panel.js on 2026-08-26, now drives the #objectives div in luxury-apartment.html from the same standing order the pause menu reads. Its elevator refusals and solo-poker line use core/dialogue.js." },
  mansion: { objectives: 2, dialogue: 2, interaction: 2, player: 2, hud: 2, pause: 2, inventory: 2, blood: 4, staging: 1, swing: 2 },
  motel: { objectives: 1, dialogue: 0, interaction: 0, player: 0, hud: 1, pause: 1, inventory: 1, blood: 0, staging: 1, swing: 0, notes: "`objectives` went 0 -> 1 on 2026-09-02. It was a journal box of its own (MAIN / OPTIONAL / WARNING SIGNS n/m) whose list was never actually shown; the shared card now carries the main line, the optional work under a WHILE YOU ARE HERE rule and the warning signs as a tally. `interaction` and `player` are this scene's own and are debts; the owner ruled on 2026-08-22 to leave them -- 'it works'." },
  nowake: { objectives: 1, dialogue: 0, interaction: 1, player: 1, hud: 1, pause: 1, inventory: 1, blood: 0, staging: 1, swing: 0, notes: "`objectives` went 0 -> 1 on 2026-09-02: the scene's own #mission-card strip ('Meet Lou at Gate C / South Harbor 12:45 PM') retired and the same two lines go on the shared card, title NO WAKE, in the same corner." },
  ...
  squatchfather: { objectives: 1, dialogue: 0, interaction: 0, player: 0, hud: 2, pause: 1, inventory: 1, blood: 1, staging: 1, swing: 0 },
  ...
  haunt: { objectives: 0, dialogue: 0, interaction: 0, player: 0, hud: 0, pause: 0, inventory: 0, blood: 0, staging: 0, swing: 0, notes: "The Stranger's client for the dev haunt (docs/DEV-HAUNT-SPIKE.md): a blind spirit-cam and prank strip talking WebRTC to a live scene. A tool for the owner, not a scene." },
});
