...
const BASE_SHOTS = [
  ...
  { name: 'variant-deathmegatron-heist', appearance: { character: 'deathmegatron', scene: 'bank_heist' },
    rig: 'studio', mark: 'full', spin: 0.42 },
  { name: 'variant-rippinflow-heist', appearance: { character: 'rippinflow', scene: 'bank_heist' },
    rig: 'studio', mark: 'full', spin: 0.42 },
  { name: 'variant-irish-no-wake', appearance: { character: 'irish', scene: 'no_wake' },
    rig: 'day', mark: 'full', spin: 0.42 },
  { name: 'variant-ape-silver-room', appearance: { character: 'ape', scene: 'silver_room' },
    rig: 'studio', mark: 'full', spin: 0.42 },
  { name: 'variant-lou-mansion-return',
    appearance: { character: 'lou', scene: 'mansion_house', variant: 'return_briefing' },
    rig: 'studio', mark: 'full', spin: 0.42 },
