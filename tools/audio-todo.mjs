...
const VOICE_DIRECTION = {
  lou: 'Captain Lou Sasole. Late fifties, forty years of this, and something wrong '
  ...
  prospect: 'The player. Younger, competent, aware he is the only one treating any of '
    + 'this as unusual. Flat and dry rather than nervous; he asks the question anybody '
    + 'would ask and gets no answer.',
