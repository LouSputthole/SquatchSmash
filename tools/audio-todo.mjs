...
out += 'Counts above cover implemented manifest cues. THE TAKE is still unbuilt; its planned '
  + 'recording coverage is listed separately below and is not counted as delivered cue work.\n\n';
...
const heistVoicePlan = fs.readFileSync(
  path.join(ROOT, 'docs', 'THE-TAKE-VOICE-PLAN.md'),
  'utf8',
).trim();
out += `## Voice — THE TAKE (planned, scene not implemented)\n\n${heistVoicePlan}\n\n`;
