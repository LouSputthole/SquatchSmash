...
export const OUTDOOR_MEMBER_STATIONS = Object.freeze([
  ...
  Object.freeze({ key: 'SEFF', name: 'SEFF', face: 'assets/faces/seff.png', shirt: 0x46505f, x: 3.4, z: -10.4 }),
  ...
  Object.freeze({ key: 'NUMBSKULL', name: 'NUMBSKULL', face: 'assets/faces/numbskull.png', shirt: 0x3f4a3a, x: 2.2, z: -9.7 }),
  ...
  Object.freeze({ key: 'LAG', name: 'LAG', face: 'assets/faces/lag.png', shirt: 0x584a3c, x: 0.9, z: -11.3 }),
