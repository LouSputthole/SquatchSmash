...
export const ROSTER = [
  ...
  circleMember({ id: 'ape', name: 'APE', archetype: ARCHETYPE.ROASTER, face: 'assets/faces/ape.png', seat: 'keg' }),
  circleMember({ id: 'irish', name: 'IRISH', archetype: ARCHETYPE.GRIEVANCE, face: 'assets/faces/irish.png', seat: 'fire' }),
