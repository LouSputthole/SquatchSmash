...
export const CIRCLE = Object.freeze([
  ...
  { key: 'SEFF', name: 'SEFF', shirt: 0x46505f, x: 2.77, z: -10.1, scale: 0.99 },
  ...
  { key: 'NUMBSKULL', name: 'NUMBSKULL', shirt: 0x3f4a3a, x: -0.2, z: -10.1, scale: 0.97 },
  ...
  { key: 'LAG', name: 'LAG', shirt: 0x584a3c, x: 0.9, z: -11.3, scale: 1.02 },
