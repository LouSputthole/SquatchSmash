 ...
 *
 * `who` is one of: LOU, PROSPECT, CECILIO, STOVE, CAIB, LOOKOUT, ASSOCIATE.
 */

export const SPEAKERS = {
  LOU: { name: 'LOU', colour: '#e8c86a' },
  PROSPECT: { name: 'PROSPECT', colour: '#cfd4e0' },
...
const L = (text, hold) => ({ who: 'LOU', text, hold });
