...
export const OBJECTIVES = {
  ...
  meetCecilioForDelivery: 'Meet Don Cecilio at the shelter before unloading Old Stove’s crates',
  unloadGuns: 'Open the cargo door, then press E on each bay to deliver Old Stove’s crates',
  ...
  approach: 'Land uphill at El Hueso — F flaps down, Space air brake as needed',
  ...
  depart: 'Get back in — the serviced aeroplane is staged for the downhill departure',
  remoteTakeoff: 'Release V — half flaps are set. Take off downhill toward the cliff',
  evade: 'Get home without being located',
  engine: 'Nurse the left engine',
  home: 'Land at Whispering Pines — F flaps, Space air brake, then B wheel brakes',
