...
const FALLBACKS = {
  ...
  'bing.office.the_boys': () => posterPlaceholder('The Boys', 'BEFORE ANY OF IT', 204),
  'bing.office.first_truck': () => posterPlaceholder('The First Truck', 'ONE ROUTE, ONE VAN', 44),
  ...
  'bing.hallway.deathmegatron': () => posterPlaceholder('DEATH', 'MEGATRON', 320),
