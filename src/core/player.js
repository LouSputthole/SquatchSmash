...
export class Player {
  ...
  _updateWalk(dt) {
    ...
    /* Jump is a vertical offset above the live ground frame rather than a
     * second world-space position. That matters on the cruiser: the deck can
     * heave and turn under an airborne player without sliding out from under
     * him, while Space still behaves like an ordinary grounded jump. */
