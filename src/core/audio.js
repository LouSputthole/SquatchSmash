...
function synth(engine, name, dest, t, rate = 1) {
  ...
  switch (name) {
    ...
    case 'plane.crash.explosion':
      // A usable hard-crash fallback while the authored ElevenLabs take is
      // absent: sub-bass impact, fuel blast, tearing metal, then a short fire
      // wash. The mission only calls this above its forgiving damage gate.
