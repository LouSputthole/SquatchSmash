 ...
 * that flight, then corrected once. Ten bisections already resolve the
 * meter more finely than a player can click it; extra passes only turned NPC
 * impact frames into visible main-thread hitches.
 */
