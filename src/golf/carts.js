...
export class Cart {
  ...
  /** Give this cart to the player instead of advancing it along a rail. */
  beginPlayerDrive() {
  ...
  /** Free-driving golf-cart handling shared by the player and follow cart. */
  ...
  /** Chase a world point with the same steering model as the player cart. */
